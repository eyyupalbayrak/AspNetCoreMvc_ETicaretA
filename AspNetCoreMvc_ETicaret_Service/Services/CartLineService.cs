...
namespace AspNetCoreMvc_ETicaret_Service.Services
{
    public class CartLineService : ICartLineService
    {
        ...
        public void Delete(CartLineViewModel model)
        {
            CartLineViewModel cartline = new CartLineViewModel();
            cartline.ProductId = model.ProductId;
            cartline.Quantity = model.Quantity;
            cartline.TotalPrince = model.TotalPrince;
            cartline.Price = model.Price;
            cartline.CartId = model.CartId;
            cartline.Id = model.Id;
